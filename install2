...
tput setaf 2 ; tput bold ; echo "	digite menu apos a instalaçao" ; tput sgr0
echo ""
...
then
	...
	wget https://raw.githubusercontent.com/extremetips/net-free/master/menu -O /bin/menu
	chmod +x /bin/menu
